          ...
          <div className="w-full p-10 flex flex-col">
            ...
            >
              {fileicon ? (
                <>
                  ...
                  <p className="mt-5 font-bold text-xl">
                    {fileicon.Path.split('\\').at(-1)?.split('/').at(-1)}
                  </p>

                  <div className="flex justify-center items-center text-gray-500">
                    <p className="mx-2">
                      Size: <span>{fileicon.sizes?.mb}MB</span>
                    </p>
                    <p className="mx-2 my-2">
                      Fragments:{' '}
                      <span>{fileicon.sizes?.chunks.toFixed(0)}</span>
                    </p>
                  </div>
              ...
              <div
                ...
                } transition-all h-6 my-2 w-full bg-indigo-300 rounded-lg p-1`}
              >
                <div
